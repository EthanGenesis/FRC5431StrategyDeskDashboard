...
export default function TeamDossierPanel({
  ...
  return (
    <div className="team-dossier-print-root">
      <DisclosureSection
        ...
        <div className="stack-12">
          ...
          >
            <button
              ...
              onClick={() =>
                downloadJsonFile(
                  `team-dossier-${teamNumber}.json`,
                  dossier ?? { teamNumber, loadedEventKey },
                )
              }
            >
              Export JSON
            ...
            <button
              ...
              type="button"
              onClick={() => printCurrentPage('Team Dossier Packet')}
            >
              Print Packet
            </button>
          </div>
